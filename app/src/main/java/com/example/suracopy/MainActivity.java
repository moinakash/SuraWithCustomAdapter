...
//
                ...
                Intent intent = new Intent(getBaseContext(), ReadSura.class);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        searchView.setOnQueryTextListener( new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextChange(String newText) {
                ...
                CustomSuraNameAdapter adp = new CustomSuraNameAdapter( MainActivity.this,R.layout.custom_suraname_layout,templist );
